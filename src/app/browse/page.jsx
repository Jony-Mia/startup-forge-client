            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-full px-4 py-1.5 text-xs font-semibold tracking-wide transition-all duration-200 border ${
                    isActive
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <button
                          ...
                          className={`text-slate-400 hover:text-slate-700 transition active:scale-95 ${
                            isSaved ? "text-[#804000] hover:text-[#804000]" : ""
                          }`}
